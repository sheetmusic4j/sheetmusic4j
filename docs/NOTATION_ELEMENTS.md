...
|---------------------------------|-------------------------------------------------------------|-----------------------------------------------------------------------------|--------------------------------------------|---------------------------------------------------------------------------------------------------|--------------------------------------------------------|------------------------------------|
| **Staff / stave**  | The 5 horizontal lines everything else sits on               | implicit (one per `<part>`/staff)                                          | —                                          | staff-row layout in `layoutStaffRow()`                                                            | `StaffLayout` (`lineY(0..4)`, `x()`, `width()`)         | `drawStaff` (line-drawing loop)    |
